...
from rest_framework.response import Response
from game.serializers import UserSerializer, MapSerializer, CharacterSerializer, UserStatsSerializer, LeaderboardSerializer
...
def get_leaderboard(request):
    players = Player.objects.all().order_by('-stats_wins')[:10]

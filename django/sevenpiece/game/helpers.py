...
def initial_setup():
    ...
    scout = Character.objects.get_or_create(name="Scout", health=2, attack=1, speed=3, special="None", image="/images/scout.png", description="Can move quickly")
    archer = Character.objects.get_or_create(name="Archer", health=2, attack=1, attack_range_min=2, attack_range_max=3, speed=1, special="None", image="/images/archer.png", description="Has distance attack")
